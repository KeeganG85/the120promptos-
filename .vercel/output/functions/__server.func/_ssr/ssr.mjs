...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BbkP36Cj.mjs");
...
var manifest = { "29b8cab67d2eb6de95ec29ee4457dbc6f42911c0e50f778cac9a3e3299c1d780": {
	...
	importer: () => import("./submit-lead-J-9Gq8RF.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DCdSzdw5.mjs").then((n) => n.t),
